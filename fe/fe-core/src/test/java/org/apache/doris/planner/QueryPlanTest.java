...
public class QueryPlanTest {
    ...
    public void testAggregateSatisfyOlapTableDistribution() throws Exception {
        ...
        // test nested colocate join can colocate agg
